...
[![Twitter Follow](https://img.shields.io/badge/Follow-%40optimltech-silver?style=flat-square&logo=x)](#)
...
```bash
./optiml-server --model model-q4_k.gguf --host 127.0.0.1 --port 8080
```
